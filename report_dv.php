...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $victim_danger = $_POST["victim_danger"];
    $reported_before = $_POST["reported_before"];
    ...
    $sql = "INSERT INTO dv_reports 
        (reporter_name, contact_email, victim_name, victim_age, victim_gender, relationship, violence_type, incident_date, location, description, suspect_name, victim_danger, reported_before, evidence_file)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<title>Report Domestic Violence</title>
...
<div class="dashboard-container" role="main" aria-labelledby="pageTitle">
  <h2 id="pageTitle">Report Domestic Violence</h2>
  ...
  <?php else: ?>
    <form action="report_dv.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
      <div class="row mb-3">
        <div class="col-md-6">
      ...
      <div class="row mb-3">
        <div class="col-md-6">
          <label for="violence_type" class="form-label">Type of Violence</label>
          <select class="form-select" id="violence_type" name="violence_type" required>
          ...
          <div class="invalid-feedback">Please select the violence type.</div>
        </div>
        <div class="col-md-6">
      ...
      <fieldset class="mb-3">
        <legend class="form-label">Is the victim currently in danger?</legend>
        <div class="btn-group btn-group-toggle" data-toggle="buttons" role="radiogroup" aria-required="true">
          <input type="radio" class="btn-check" name="victim_danger" id="danger_yes" value="Yes" required>
          <label class="btn btn-outline-primary" for="danger_yes">Yes</label>

          <input type="radio" class="btn-check" name="victim_danger" id="danger_no" value="No" required>
          <label class="btn btn-outline-primary" for="danger_no">No</label>
        </div>
        <div class="invalid-feedback d-block">Please select if victim is currently in danger.</div>
      </fieldset>

      <fieldset class="mb-4">
        <legend class="form-label">Was this reported before?</legend>
        <div class="btn-group btn-group-toggle" data-toggle="buttons" role="radiogroup" aria-required="true">
          <input type="radio" class="btn-check" name="reported_before" id="reported_yes" value="Yes" required>
          <label class="btn btn-outline-primary" for="reported_yes">Yes</label>

          <input type="radio" class="btn-check" name="reported_before" id="reported_no" value="No" required>
          <label class="btn btn-outline-primary" for="reported_no">No</label>
        </div>
        <div class="invalid-feedback d-block">Please select if this was reported before.</div>
      </fieldset>
